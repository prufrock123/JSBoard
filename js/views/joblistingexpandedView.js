;(function(window, undefined){
	...
	var JobListingExpandedView = Backbone.View.extend({
		...
		template: "<div class='small-12 columns'><h2>{jobTitle}</h2><h4>{type}</h4><h4>{aboutUs}</h4><p>consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p></div>",
